...
if (strstr($_SERVER["HTTP_HOST"], "127.0.0.1")) {
    define('UC_API', strtolower((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == 'on' ? 'https' : 'http') . '://127.0.0.1:9091/uc_server/'));
} else {
    define('UC_API', strtolower((isset($_SERVER['HTTPS']) && $_SERVER['HTTPS'] == 'on' ? 'https' : 'http') . '://bbs.thinkimf.com/uc_server/'));
}
define('UC_DATADIR', UC_ROOT . './data/');
define('UC_DATAURL', UC_API . '/data');
//define('UC_API_FUNC', UC_CONNECT == 'uc_api_post' ? 'uc_api_post' : 'uc_api_post');
define('UC_API_FUNC', "uc_api_post");
$GLOBALS['uc_controls'] = array();

define('UC_CONNECT', 'mysql');

define('UC_DBHOST', '120.78.150.141');
define('UC_DBUSER', 'root');
define('UC_DBPW', 'udinfo');
define('UC_DBNAME', 'xcommunity');
define('UC_DBCHARSET', 'utf8');
define('UC_DBTABLEPRE', '`xcommunity`.pre_ucenter_');
define('UC_DBCONNECT', 0);

define('UC_CHARSET', 'utf-8');
define('UC_KEY', 'Ldi6DdL3yc34A5wcb0Abb0weF8F5y2F77eS1oce2ibA7b4B4ibm2O3o6YfecC767');
define('UC_APPID', '1');
define('UC_IP', '');
define('UC_PPP', 20);
